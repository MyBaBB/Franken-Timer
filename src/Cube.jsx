...
<br />
       ...
       <div className="text-white px-4 sm:px-8 py-3 hover:bg-sky-800    m-0"></div>
         
        <a href="https://Mybabb.com">
          <div className="topParagraphWrapper">
            <p className="topParagraph  text-2xl sm:text-3xl md:text-4xl lg:text-4xl whitespace-nowrap">
              St. Patrick&apos;s Day ☘️
            </p>
          </div>
        </a>
        ...
        <p className="whitespace-nowrap fixed bottom-0 right-5">
          <span className="text-white text-[8px] sm:text-[10px] lg:text-sm">

...
const Timer = () => {
  ...
  var countDownDate = new Date("September 1, 2025 00:00:00 PST").getTime();
  ...
  var x = setInterval(function () {
    ...
    if (distance < 0) {
      ...
      document.getElementById("demo").innerHTML =
        ...
        " <span class='timerStylesFinished1'>Service</span>" +
        "<span class='timerStylesFinished2'>🐕‍🦺 </span>" +
        "<span class='timerStylesFinished3'>Animals</span>" +
